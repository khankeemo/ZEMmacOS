...
class DashboardWidget:
    ...
    def build(self)->ttk.Frame:
        ...
        tk.Label(self.frame,text=labels.get('license_status_section', "License Status"),font=("Helvetica",14,"bold"),fg="#333").pack(pady=(10,5))
        ...
        tk.Button(self.frame,text=labels.get('refresh_btn',"Refresh"),command=self.refresh,font=("Helvetica",9),bg="#e5e7eb",fg="#333",relief=tk.FLAT,padx=10,pady=3).pack(pady=(8,5))
