...
class SettingsWidget:
    ...
    def _build_tab(self,parent):
        ...
        tk.Label(cv,text=labels.get('license_info_section',"License Information"),font=("Helvetica",13,"bold"),bg="#f8f9fa",fg="#333").pack(anchor=tk.W,pady=(0,12))
        ...
        for cmd,clr,txt in [(self._open_activation,"#6366f1",labels.get('activate_btn',"Activate")),
                            (self._open_renewal,"#10b981",labels.get('renew_btn',"Renew")),
                            (self._open_replace,"#f59e0b",labels.get('replace_btn',"Replace Device")),
                            (self.refresh,"#6b7280",labels.get('refresh_btn',"Refresh")),
                            (self._open_welcome,"#8b5cf6",labels.get('open_welcome_btn',"Open Welcome"))]:
    ...
    def _open_activation(self):
        ...
        ActivationDialog(self.engine, parent=self.parent).show(); self.refresh()
